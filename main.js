...
document.getElementById('btnKetQua').onclick = function () {
    ...
    var ketQua = '';
    var diemfull = 0;
    var tongDiem = tinhDiem('diem1', 'diem2', 'diem3');
    diemfull = tongDiem + khuVuc('luaChonKhuVuc') + doiTuong('luaChonDoiTuong');
    if (diemfull >= diemchuan) {
        ketQua = 'Chúc mừng bạn đã thi đậu ';
    }
    else {
        ketQua = ' Bạn đã thi trượt ';
    }
    if (tongDiem == 0) {
        document.getElementById('ketQua_2').innerHTML = "Bạn đã bị điểm liệt => bạn đã thi trượt";

    } else{
        document.getElementById('ketQua_2').innerHTML = ketQua + "& Số điểm đạt được là : " + diemfull;
    }
...
document.getElementById('btnTinhTongTien').onclick = function(){
    ...
    document.getElementById('ketQua_b2').innerHTML ="Xin chào " + tenNguoi +" !" + " Bạn có sô tiền phải trả là : " + tongTien.toLocaleString()+" vnđ";
